...
%% Load data
clear
load GeneratedputBatesForSmoothing.mat
% load data_20190603_25_32.mat
ivs = ivs/100;
r = [4.36000000000000;4.47000000000000;4.53000000000000;4.57000000000000;4.71000000000000;4.85000000000000;4.93000000000000;5.04000000000000]
r = r/100;
...
[call_price, put_price] = blsprice(dax, strike, interestrate, maturity, implied_volatility, q);
[u, tau, g, gamma] = ivs_smoothed(put_price, dax, strike, ...
    maturity, interestrate, q, implied_volatility);
[put_price_smoothed, implied_volatility_smoothed] = ...
    evaluateSpline(u, tau, g, gamma, dax, strike, ...
    interestrate, maturity, q);

% Plot Original and Arbitrage-Free Smoothed Prices
figure1 = figure;
plot(strike, put_price, 'ob');
hold on
plot(strike, put_price_smoothed, 'xr');
title('put Option Prices (01 January 2019)');
xlabel('Strike');
ylabel('Option Price');
...
figure2 = figure;
pos = maturity==tau(1);
plot(strike(pos), put_price(pos), 'ob');
hold on
plot(strike(pos), put_price_smoothed(pos), 'xr');
title('put Option Prices (01 January 2019)');
xlabel('Strike');
ylabel('Option Price');
legend('Original Prices', 'Smoothed Prices');
