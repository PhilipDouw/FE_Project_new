%% Interpolation Error Black-Scholes:
...
[MatrixVIX, VIX, VIXerror] = VIX_computationBS(S ,K_min ,K_max, interval, r, T,sigma);
...
[MatrixVIXNear, VIXNear, VIXerrorNear] = VIX_computationBS(S ,K_min ,K_max, interval, r, T1,sigma);
...
[MatrixVIXNext, VIXNext, VIXerrorNext] = VIX_computationBS(S ,K_min ,K_max, interval, r, T2,sigma);
