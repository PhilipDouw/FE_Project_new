% Smooth interpolation Black-Sholes:

function [Matrix, yy] = PCMatrixBSInter(S, K_min, K_max, interval, T, r, sigma)
...
for l = 1 : length(Matrix)
    ...
    if Matrix(l,1) < K_zero
        ...
        Matrix(l,7) = blsimpv(S,Matrix(l,1),r,T,Matrix(l,6), 'Class', {'Put'});
        
    else
        
        Matrix(l,7) = blsimpv(S,Matrix(l,1),r,T,Matrix(l,6), 'Class', {'Call'});
    end
